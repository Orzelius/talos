...
func (p *QemuProvisioner) createVirtualTPM2State(state *vm.State, nodeName string) (tpm2Config, error) {
...
func (p *QemuProvisioner) destroyVirtualTPM2s(cluster provision.ClusterInfo) error {
...
func (p *QemuProvisioner) destroyVirtualTPM2(pid string) error {
