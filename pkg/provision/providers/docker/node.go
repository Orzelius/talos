...
func (p *DockerProvisioner) createNodes(
	ctx context.Context,
...
//nolint:gocyclo
func (p *DockerProvisioner) createNode(ctx context.Context, clusterReq ClusterRequest, nodeReq NodeRequest, options *provision.Options) (provision.NodeInfo, error) {
	env := []string{
		"PLATFORM=container",
...
func (p *DockerProvisioner) listNodes(ctx context.Context, clusterName string) ([]types.Container, error) {
...
func (p *DockerProvisioner) destroyNodes(ctx context.Context, clusterName string, options *provision.Options) error {
