...
func NewDockerProvisioner(ctx context.Context) (*DockerProvisioner, error) {
	p := &DockerProvisioner{}
...
func (p *DockerProvisioner) GenOptions(networkReq provision.NetworkRequestBase) []generate.Option {
...
func (p *DockerProvisioner) GetInClusterKubernetesControlPlaneEndpoint(networkReq provision.NetworkRequestBase, controlPlanePort int) string {
...
func (p *DockerProvisioner) GetExternalKubernetesControlPlaneEndpoint(provision.NetworkRequestBase) string {
...
func (p *DockerProvisioner) GetTalosAPIEndpoints(provision.NetworkRequestBase) []string {
...
func (p *DockerProvisioner) UserDiskName(index int) string {
	return ""
}

// GetFirstInterface returns first network interface name.
func (p *DockerProvisioner) GetFirstInterface() v1alpha1.IfaceSelector {
