...
func (p *DockerProvisioner) createNetwork(ctx context.Context, req NetworkRequest) error {
...
func (p *DockerProvisioner) listNetworks(ctx context.Context, name string) ([]network.Inspect, error) {
...
func (p *DockerProvisioner) destroyNetwork(ctx context.Context, name string) error {
