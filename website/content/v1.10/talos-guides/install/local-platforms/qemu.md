...
To see a live linux demo of this writeup, see the video below:
...
On macos the hvf accelerator is utilized. Networking is created by QEMU via the [apple vmnet framework](https://developer.apple.com/documentation/vmnet) which handles everything but the DHCP for which a custom server is used instead.
